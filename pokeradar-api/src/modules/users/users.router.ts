...
router.post('/me/telegram/link-token', (req, res, next) => controller.generateTelegramLinkToken(req, res, next));
router.delete('/me/telegram', (req, res, next) => controller.unlinkTelegram(req, res, next));
router.post('/me/discord/link-token', (req, res, next) => controller.generateDiscordLinkToken(req, res, next));
