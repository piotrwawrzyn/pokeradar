...
router.post(
  ...
  (req, res, next) => productsCtrl.createSet(req, res, next),
);
router.patch(
  '/product-sets/:id',
  validate(updateProductSetSchema),
  (req, res, next) => productsCtrl.updateSet(req, res, next),
);
router.delete('/product-sets/:id', (req, res, next) =>
  productsCtrl.removeSet(req, res, next),
);
router.post(
  '/product-sets/:id/image',
  imageUpload.single('image'),
  (req, res, next) => productsCtrl.uploadSetImage(req, res, next),
);

// ProductTypes CRUD
router.get('/product-types', (req, res, next) =>
  productsCtrl.listTypes(req, res, next),
);
router.post(
  '/product-types',
  validate(createProductTypeSchema),
  (req, res, next) => productsCtrl.createType(req, res, next),
);
router.patch(
  '/product-types/:id',
  validate(updateProductTypeSchema),
  (req, res, next) => productsCtrl.updateType(req, res, next),
);
router.delete('/product-types/:id', (req, res, next) =>
  productsCtrl.removeType(req, res, next),
);
...
router.get('/notifications', (req, res, next) =>
  notificationsCtrl.list(req, res, next),
);
