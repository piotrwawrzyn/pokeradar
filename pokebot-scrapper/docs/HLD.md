# Pokebot — High-Level Design

## What Is Pokebot?

Pokebot is a Pokemon TCG price-monitoring platform. It tracks prices of Pokemon products across 25 Polish e-commerce shops and alerts users via Telegram when a product they're watching drops to their desired price. The system has three services sharing a single MongoDB database.
...
### 1. pokebot-scrapper (Price Scanner + Notifier)
